...
<html style="padding: 0; margin: 0;" lang="en-US">
	...
	<body style="padding: 0; margin: 0; font-family: Helvetica, Arial, sans-serif;">
		<table cellpadding="0" cellspacing="0" style="background: url('http://sub2home.com/img/static/common/note_background.jpg') repeat; width: 100%; color: #d1ba82;">
			<tbody>
				<tr>
		...
		<table cellpadding="0" cellspacing="0" height="10" style="background: url('http://sub2home.com/img/static/common/note_bottom.png') repeat-x; width: 100%">
			<tbody>
				<tr>
					<td></td>
				</tr>
